...
export async function POST(req: any) {
   ...
   ***Loob Magic Analysis: Following this line, provide a structured analysis in JSON format of the users mood( positive, negative, or neutral) and keywords (from the users half of the conversation). After sending the analysis, ask for consent to send the data to the collective visualization.***
