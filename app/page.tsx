...
} from "../components/AnalysisDataContext";
...
export default function Page() {
  ...
  const handleCloseModal = () => {
    setShowModal(false);
    window.location.reload(); // Consider replacing this with more refined state management
  };
  ...
  if (showNeuronVisual) {
    return (
      <AnalysisDataProvider>
        {" "}
        {/* Added AnalysisDataProvider to wrap Dashboard component */}
        <>
      ...
      </AnalysisDataProvider> // Closing tag for AnalysisDataProvider
    );
  }
  ...
  return (
    <AnalysisDataProvider>
      {" "}
      {/* Added AnalysisDataProvider to wrap entire main structure */}
      {showSplash ? (
    ...
    </AnalysisDataProvider> // Ensure that the closing tag wraps around the entire conditional rendering
  );
}
