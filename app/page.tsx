...
export default function Page() {
  ...
  // Modified Insights button functionality to prepare messages for the dashboard
  const handleInsightsClick = () => {
    setShowNeuronVisual(true);
    // Additional logic to send messages to the dashboard will be needed
  };

  if (showNeuronVisual) {
    return (
      <>
        <Dashboard /> {/* Ensure Dashboard is prepared to receive and display messages as needed */}
        <button
