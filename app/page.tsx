      ...
      {!username && (
        <div className="bg-gray-100 p-4 rounded-lg">
          ...
          <p className="text-sm text-gray-500 mt-2">
            PLease give a name, anything is fine.
          </p>
        </div>
      )}
...
return (
  <>
    {/* Conditionally render UsernameModal if username is not set */}
    {!username && <UsernameModal />}
    
    {/* Conditionally render Dashboard and Back to Chat button if showNeuronVisual is true */}
    {showNeuronVisual && (
      <>
        <Dashboard />
    ...
    {/* Main content should be wrapped in a single fragment */}
    {!showNeuronVisual && (
      <main>
        ...
        {/* Render Configure component if configureOpen is true */}
        {configureOpen && (
          <Configure
